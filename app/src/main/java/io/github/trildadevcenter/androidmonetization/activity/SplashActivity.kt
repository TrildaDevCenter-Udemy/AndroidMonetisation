...
import io.github.trildadevcenter.androidmonetization.R
import io.github.trildadevcenter.androidmonetization.application.Monitor
...
class SplashActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    Timber.tag(LOG_TAG).d("Google Mobile Ads SDK Version: " + MobileAds.getVersion())
    ...
    googleMobileAdsConsentManager.gatherConsent(this) { consentError ->
      if (consentError != null) {
        ...
        Timber.tag(LOG_TAG).w(String.format("%s: %s", consentError.errorCode, consentError.message))
      }
    ...
    val countDownTimer: CountDownTimer =
      object : CountDownTimer(COUNTER_TIME_MILLISECONDS, 1000) {
        ...
        override fun onFinish() {
          ...
          (application as Monitor).showAdIfAvailable(
            this@SplashActivity,
            object : Monitor.OnShowAdCompleteListener {
