package io.github.trildadevcenter.androidmonetization.util
...
class BillingAgent(val activity: Activity, val callback: BillingCallback): PurchasesUpdatedListener {
    ...
    override fun onPurchasesUpdated(
        ...
        checkProduct(billingResult, purchases as MutableList<Purchase?>?)
        checkSubscription(billingResult, purchases)
    }


    //TODO PPL check if we can have LIST and not Mutable List Here as aboe we got a List and not a Mutable List
